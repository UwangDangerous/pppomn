<div class="card p-3">
    <form action="" method="post" >
        ...
        <input type="text" name="nama_ruangan" id="nama_ruangan" class='form-control mb-3' value='<?= set_value('nama_ruangan') ;?>' autofocus autocomplete="off">
        ...
        <input type="text" name="lokasi" id="lokasi" class='form-control mb-3' value='<?= set_value('lokasi') ;?>' autofocus autocomplete="off">
